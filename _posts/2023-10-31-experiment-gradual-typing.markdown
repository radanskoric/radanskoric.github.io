...
If you are finding this useful, consider subscribing to not miss future articles and get extra subscriber only articles:
...
The exploration also resulted in ["Should I add typing to my Ruby project?"](/articles/should-i-add-typing-to-my-ruby-project). It also got me thinking about what other [tools can be used to prevent bugs in Ruby projects](/articles/preventing-bugs-in-ruby-tools-of-the-trade).
